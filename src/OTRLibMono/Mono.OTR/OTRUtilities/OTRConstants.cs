...
namespace Mono.OTR.Utilities
{
	public class OTRConstants
	{
        ...
        public const byte DEFAULT_OTR_VERSION = 0x0003;


        private static BigInteger PRIME_MODULO = null;
        private static BigInteger PRIME_MODULO_MINUS_2 = null;
        private static BigInteger GENERATOR = null;
        private static BigInteger SM_MODULO = null;
       ...
       private static bool _is_modulo_values_set = false;


		public static BigInteger RFC_3526_PRIME_MODULO()
        {
            if (_is_modulo_values_set == false)
                SetModuloValues();
		...
		public static BigInteger SM_PRIME_MODULO() 
		{
           if (_is_modulo_values_set == false)
                SetModuloValues();
		...
		public static BigInteger RFC_3526_GENERATOR ()
		{
		...
		private static void SetModuloValues ()
		{
    ...
    {
        BigInteger _private_key = null;
        BigInteger _public_key = null;
        UInt32 _key_id = 0;
        ...
        public DHKeyPair(BigInteger private_key, BigInteger public_key, UInt32 key_id)
        {
            ...
            if (public_key.CompareTo(BigInteger.Zero) < 0)
        ...
        {
            if (_private_key.CompareTo(BigInteger.Zero) < 0)
        ...
        {
            if (_public_key.CompareTo(BigInteger.Zero) < 0)
